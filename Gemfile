...
# Frontend gems
gem 'bootstrap', '~> 4.0.0.beta2' # Bootstrap 4 Ruby Gem for Rails / Sprockets and Compass
...
gem 'octicons_helper', '~> 4.2.0' # A rails helper that makes including svg Octicons simple.
...
gem 'sidekiq', '~> 5.1.0' # Simple, efficient background processing for Ruby.
