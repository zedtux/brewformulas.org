...
gem 'octicons_helper', '~> 4.0.6' # A rails helper that makes including svg Octicons simple.
...
gem 'sidekiq-scheduler', '~> 2.1.9' # Light weight job scheduling extension for Sidekiq that adds support for queueinga jobs in a recurring way.
